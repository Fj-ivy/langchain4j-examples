...
import static org.ivy.classification.enums.CustomerServiceCategory.*;

public class ClassifyExamples {
    @Getter
    private static final Map<CustomerServiceCategory, List<String>> examples = new HashMap<>();
